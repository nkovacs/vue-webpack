...
{{indent 2 ~}}      index: path.resolve(__dirname, {{string '../dist/index.html'}}),
{{indent 2 ~}}      assetsRoot: path.resolve(__dirname, {{string '../dist'}}),
{{indent 2 ~}}      assetsSubDirectory: {{string 'static'}},
{{indent 2 ~}}      assetsPublicPath: {{string '/'}},
...
{{indent 2 ~}}      productionGzipExtensions: [{{string 'js'}}, {{string 'css'}}],
